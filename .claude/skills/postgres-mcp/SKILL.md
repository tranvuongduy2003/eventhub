---
name: postgres-mcp
description: Inspects and queries the local PostgreSQL database via the Claude Code MCP server (read-only). Use when verifying data, debugging persistence, exploring schema, writing SELECT diagnostics, or when the user mentions Postgres MCP, database rows, or SQL inspection.
---
