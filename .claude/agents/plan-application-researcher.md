---
description: "/plan subagent. Researches src/Application — CQRS commands, queries, handlers, validators, Application ports. Input spec path + AC ids. Returns handler paths and patterns to copy; readonly; no Infrastructure/Domain edits."
tools:
  - Read
  - Grep
  - Glob
...
- `src/Application/**`
- CQRS pipeline — `architecture.md` §4–5, `docs/technical.md` §4
...
1. Read `.claude/agent-memory/plan-application-researcher.md` if present.
