---
description: "/plan subagent. Researches Infrastructure, Api, Contracts, Api.IntegrationTests — EF, HTTP, OpenAPI, Testcontainers patterns. Input spec path + AC ids. Readonly; returns endpoint/persistence/test paths for the plan."
tools:
  - Read
  - Grep
  - Glob
...
- `migration.md`, `api-guidelines.md`, Tech §6–7

**Out of scope:** Domain aggregates, React UI.

## On start

1. Read `.claude/agent-memory/plan-infrastructure-researcher.md` if present.
