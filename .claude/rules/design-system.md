---
description: "EventHub UI design system — Tailwind v4 tokens, shadcn/ui primitives, mobile-first layout, WCAG 2.1 AA accessibility, and key surfaces (event pages, checkout, dashboard, QR tickets, check-in). Use when building or styling React components in web/."
paths:
  - "web/**/*.tsx"
  - "web/**/*.css"
  - "web/**/components/**"
...
Apply under `web/`. Consult `CLAUDE.md`, `frontend.md`, [`docs/prd.md`](../../docs/prd.md) QG-4 first.
