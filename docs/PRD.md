...
deliberately_excluded:
  - detailed_feature_specifications             # see companion document: features.md
  - technical_architecture_and_implementation   # see companion document: technical.md
...
- **Specific feature specifications** (capabilities, user stories, acceptance criteria, screen-by-screen behavior) → see `features.md`.
- **Specific technical details** (architecture, data models, integrations, infrastructure, security implementation) → see `technical.md`.
...
- When a topic belongs to a companion document, this is stated with a pointer such as `→ see features.md`.
...
*This PRD is a living draft for a personal project. Detailed features are maintained in `features.md`; technical design is maintained in `technical.md`. The decisions in Section 11 are intentional and may be revised as the project evolves.*
