...
feature_id: F-5.4
status: implemented
created: "2026-07-05T16:06:17+07:00"
updated_at: "2026-07-05T16:31:00+07:00"
phase: MVP
personas: [PER-A1, PER-A2]
depends_on: [F-5.3, F-3.3]
ddd_refs: [BC-3, AGG-Order, ENT-OrderLine, INV-20, INV-25]
prd_refs: [DEC-1, DEC-3, QG-2, QG-4, QG-6]
tech_refs: ["Tech Section 4", "Tech Section 7", "Tech Section 12"]
---
...
|------|--------|
| `harness/evals/` | N/A |
| `harness/orchestrator/` | N/A |
| `.codex/policies/` or `harness/policies/` | N/A |
| `harness/telemetry/` | N/A |
| `harness/tools/` | N/A |
