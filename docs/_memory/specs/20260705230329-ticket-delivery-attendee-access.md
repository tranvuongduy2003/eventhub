...
status: implemented
epic: EP-7
features: [F-7.1, F-7.2, F-7.3, F-7.4, F-7.5, F-7.6]
ddd_refs: [BC-5, BC-6, AGG-Ticket, VO-TicketCode, EVT-OrderConfirmed, EVT-TicketIssued, INV-40]
created: "2026-07-05"
updated: "2026-07-10"
---
...
| Lane | Impact |
|------|--------|
| `harness/evals/` | N/A - no eval runner or case changes. |
| `harness/orchestrator/` | N/A - no orchestration contract changes. |
| `.codex/policies/` / `harness/policies/` | N/A - no policy or approval changes. |
| `harness/telemetry/` | N/A - no harness telemetry changes. |
| `harness/tools/` | N/A - no harness tool adapter changes. |
