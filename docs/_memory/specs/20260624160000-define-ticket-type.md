...
- **Currency validation:** The price currency must match the system's single configured currency. No multi-currency support (out of scope per `product-requirements.md` §6.2).
