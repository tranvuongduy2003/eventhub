...
- The Event aggregate and ENT-TicketType already support multiple types per event in the domain model (domain-model-specification.md). This feature activates and end-to-end tests that behavior.
