...
Reference: `ddd.md` BC-1 (Identity & Access), BC-2 (Event Management). The role assignment model bridges the User aggregate (identity) and the Event aggregate (context).
