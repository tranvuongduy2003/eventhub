...
doc_id: spec-20260710184016-event-day-check-in
title: Event-Day Check-in
slug: event-day-check-in
status: implemented
...
- `.codex/agents/`: N/A - product slice only; no harness behavior changes.
- `.codex/policies/` or `.codex/hooks/`: N/A - product slice only; no harness behavior changes.
