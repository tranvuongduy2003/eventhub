...
3. **Existing aggregate boundaries.** Inventory lives on the Event aggregate (not a separate Inventory aggregate). This is the documented design in domain-model-specification.md.
