...
- Consumer integration tests: RabbitMQ delivery, inbox deduplication, retry/dead-letter behavior, projections, and notifications; follow the current repository layout.
...
- Prefer real engines/Testcontainers when an in-process fake would hide transaction, SQL, broker, cache, or object-storage behavior.
