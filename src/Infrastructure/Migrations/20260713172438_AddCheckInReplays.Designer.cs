...
namespace EventHub.Infrastructure.Migrations
{
    ...
    [Migration("20260713172438_AddCheckInReplays")]
    partial class AddCheckInReplays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.CheckInReplayRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CodeFingerprint")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("EventId", "ClientScanId")
                        .IsUnique()
                        .HasDatabaseName("ux_check_in_replays_event_id_client_scan_id");

                    b.ToTable("check_in_replays", "app");
                });

            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.DiscountCodeRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_discount_codes_event_id");

                    b.HasIndex("EventId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_discount_codes_event_id_code");

                    b.ToTable("discount_codes", "app");
                });
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.EventReminderRecord", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("integer")
                        .HasColumnName("event_id");
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.OccurrenceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_occurrences_event_id");

                    b.ToTable("occurrences", "app");
                });

            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.OrderLineRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("order_lines", "app");
                });

            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.OrderRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.ReservationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_reservations_expires_at");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_reservations_order_id");

                    b.ToTable("reservations", "app");
                });

            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.TicketRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.TicketTypeRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTimeOffset?>("SalesWindowEnd")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sales_window_end");

                    b.Property<DateTimeOffset?>("SalesWindowStart")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sales_window_start");
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.CheckInReplayRecord", b =>
                {
                    b.HasOne("EventHub.Infrastructure.Persistence.Entities.EventRecord", null)
                        .WithMany()
                    ...
                    b.HasOne("EventHub.Infrastructure.Persistence.Entities.TicketRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventHub.Infrastructure.Persistence.Entities.OrderLineRecord", b =>
                {
                    b.HasOne("EventHub.Infrastructure.Persistence.Entities.OrderRecord", null)
                        .WithMany("Lines")
                    ...
                    b.HasOne("EventHub.Infrastructure.Persistence.Entities.TicketTypeRecord", null)
                        .WithMany()
