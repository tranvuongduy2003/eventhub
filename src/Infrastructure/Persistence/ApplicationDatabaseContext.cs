    ...
    : DbContext(options), IApplicationDatabaseContext
{
    ...
    public DbSet<TicketTypeRecord> TicketTypes => Set<TicketTypeRecord>();
    ...
    public DbSet<DiscountCodeRecord> DiscountCodes => Set<DiscountCodeRecord>();
    ...
    public DbSet<CheckInReplayRecord> CheckInReplays => Set<CheckInReplayRecord>();
